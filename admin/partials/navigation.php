                    ...
                    <ul class="metisMenu nav flex-column" id="menu">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav-second-level nav flex-column " aria-expanded="false">
								<li class="nav-item"><a class="nav-link" href="categorie.php">Categorie blog</a></li>
                                <li class="nav-item"><a class="nav-link" href="blog.php">Blog</a></li>
                                 <li class="nav-item"><a class="nav-link" href="commentaire.php">Commentaire</a></li>
                            </ul>
                        </li>
						<!--  <li class="nav-item">
                          ...
                          <li class="nav-heading"><span>CONTACTS, DATA & LAYOUTS</span></li>
						<li class="nav-item">
                            ...
                            <ul class="nav-second-level nav flex-column sub-menu" aria-expanded="false">
                                <li class="nav-item"><a class="nav-link" href="contact.php">All messages</a></li>
                                <li class="nav-item"><a class="nav-link" href="contact.php">Inbox view</a></li>
                                <li class="nav-item"><a class="nav-link" href="contact.php">Inbox no view</a></li>
                            </ul>
                        </li>
                        <li class="nav-heading"><span>OTHERS</span></li>
                        <li class="nav-item">
                        <a  class="nav-link" href="galerie.php" aria-expanded="false"><i class="fa fa-cogs"></i> <span class="toggle-none">GALERIE </span></a>
                        </li>
                       
                        <li class="nav-item">
                        <a  class="nav-link" href="offre.php" aria-expanded="false"><i class="fa fa-codepen"></i> <span class="toggle-none">OFFRE </span></a>
                        </li>
                        <li class="nav-item">
                        <a  class="nav-link" href="user.php" aria-expanded="false"><i class="fa fa-user"></i> <span class="toggle-none">USERS </span></a>
                        </li>
                       <!--  <li class="nav-item">
